...
const navItems: Array<{ to: string; labelKey: string; icon: ReactNode }> = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
        <path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567l-.109.661a7.49 7.49 0 0 0-1.679.972l-.602-.349a1.875 1.875 0 0 0-2.532.657l-.75 1.299a1.875 1.875 0 0 0 .682 2.55l.567.327a7.658 7.658 0 0 0 0 1.944l-.567.327a1.875 1.875 0 0 0-.682 2.55l.75 1.299a1.875 1.875 0 0 0 2.532.657l.602-.349c.52.407 1.08.751 1.679.972l.602.349a1.875 1.875 0 0 0 2.532-.657l.75-1.299a1.875 1.875 0 0 0-.682-2.55l-.567-.327a7.658 7.658 0 0 0 0-1.944l.567-.327a1.875 1.875 0 0 0 .682-2.55l-.75-1.299a1.875 1.875 0 0 0-2.532-.657l-.602.349a7.49 7.49 0 0 0-1.679-.972l-.109-.661A1.875 1.875 0 0 0 12.578 2.25h-1.5ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z" clipRule="evenodd" />
      </svg>
    ),
  },
]
